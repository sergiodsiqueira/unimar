        ...
        <div class="col-12 col-md-6 col-xl-7">
          <div class="d-flex justify-content-center text-bg-primary">
            <div class="col-12 col-xl-9">
              ...
              <p class="lead mb-5">Soluções de gestão que garantem melhores resultados e maxima eficiência</p>
              <div class="text-endx">
        ...
        <div class="col-12 col-md-6 col-xl-5">
          <div class="card border-0 rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
                ...
                <div class="row gy-3 overflow-hidden">
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="email" class="form-control" name="email" id="email" value="<?php echo isset($_COOKIE['cemail']) ? $_COOKIE['cemail'] : ''; ?>" required>
                      <label for="email" class="form-label">Email</label>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="password" class="form-control" name="senha" id="senha" value="<?php echo isset($_COOKIE['csenha']) ? $_COOKIE['csenha'] : ''; ?>" required>
                      <label for="senha" class="form-label">Senha</label>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="lembrar" id="lembrar" <?php echo isset($_COOKIE['clembrar']) ? $_COOKIE['clembrar'] : '' ?>>
                      <label class="form-check-label text-secondary" for="lembrar">
                        Lembrar-se
                      </label>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="d-grid">
                      <button class="btn btn-primary btn-lg" type="submit" value="login" id="login">ENTRAR</button>
                    </div>
                  </div>
                </div>
              </form>
              ...
              <div class="row">
                <div class="col-12">
                  <p class="mt-4 mb-4">Ou continuar com</p>
